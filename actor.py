...
class ActorNetwork(tf.keras.Model):
    def __init__(self, embedding_dim, hidden_dim):
        ...
        self.inputs = tf.keras.layers.InputLayer(name='input_layer', input_shape=(embedding_dim,))
...
class Actor(object):
    ...
    def build_networks(self):
        ...
        self.network(np.zeros((1, self.embedding_dim)))
        self.target_network(np.zeros((1, self.embedding_dim)))
